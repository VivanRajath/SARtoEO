...
The end-to-end system consists of three distinct phases: Model Training, Inference, and Metric Evaluation.
...
├────────────────────────────────────────────────────────────────────────┤
│                                                                        │
│  [Sentinel-1 SAR (x)]                  [Sentinel-2 Real EO (y)]        │
│          │                                        │                    │
│          ├───────────────────┐                    │                    │
│          ▼                   ▼                    │                    │
│    ┌───────────┐       ┌───────────┐              │                    │
...
│          │                     ▼                                       │
│          ▼               [Adv Loss (G)]                                │
│    [Total G Loss]        [Adv Loss (D)]                                │
│          │                                                             │
│          ▼                                                             │
│  [Optimizer Update] ──► Save Checkpoint (.pth)                         │
│                                                                        │
└────────────────────────────────────────────────────────────────────────┘
...
├────────────────────────────────────────────────────────────────────────┤
│                                                                        │
│  [New SAR Images] ──► [Resize & Normalize] ──► [Generator (eval)]      │
│                                                       │                │
│                                                       ▼                │
│  [Outputs Directory] ◄── [Save RGB PNG] ◄── [Denormalize (0-255)]      │
│                                                                        │
└────────────────────────────────────────────────────────────────────────┘
